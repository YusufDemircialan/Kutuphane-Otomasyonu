...
namespace Kütüphane
{
    public partial class YöneticiÜyeEkle : Form
    {
        public YöneticiÜyeEkle()
        {
            InitializeComponent();
        }
                ...
                if (txtTc.Text.Length == 11)
                {
                    ...
                    if ((birlerbasamagikural1[birlerbasamagikural1.Length - 1] == hane11) && (birlerbasamagikural2[birlerbasamagikural2.Length - 1] == hane10) && (birlerbasamagikural3[birlerbasamagikural3.Length - 1] == hane11))
                    {
                        ...
                        if (kontrol == true)
                        {
                            ...
                            {
                                baglanti.Open();
                                SqlCommand komut = new SqlCommand("insert into Uye(tc,kullanici_adi,ad,soyad,yas,cinsiyet,telefon,email,okunankitapsayisi) values (@tc,@kullanici_adi,@ad,@soyad,@yas,@cinsiyet,@telefon,@email,@okunankitapsayisi)", baglanti);
                                ...
                                komut.Parameters.AddWithValue("@okunankitapsayisi", txtOkununkitapsayisi.Text);
                                SqlCommand komut2 = new SqlCommand("insert into ÜyeBilgi(kullanici_adi,sifre) values (@kullanıcıadı,@sifre)", baglanti);
        ...
        private void YöneticiÜyeEkle_Load(object sender, EventArgs e)
        {
