...
namespace Kütüphane
{
    public partial class ÜyeGiriş : Form
    {
        ...
        public static string KullaniciAdSoyad = string.Empty;
        ...
        private void guna2GradientButton2_Click(object sender, EventArgs e)
        {
            ...
            baglanti.Open();
            SqlCommand komut = new SqlCommand("select * from ÜyeBilgi where kullanici_adi ='" + guna2TextBox1.Text + "' and sifre = '" + guna2TextBox2.Text + "'", baglanti);
